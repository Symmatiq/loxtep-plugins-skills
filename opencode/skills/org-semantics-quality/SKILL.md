...
description: Use when the user wants org-level schema definitions, semantic definitions, PII tagging, schema versions, quality rules, test quality rules, or governance on definitions — not catalog search. Customer MCP loxtep_schemas and loxtep_quality.
license: MIT
