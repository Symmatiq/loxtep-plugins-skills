...
description: Use when the user wants to discover data in the catalog, search assets, lineage impact, evidence, governance flags, run discovery, list domains or tags, or understand "what connects to what" in Discover. Customer MCP tool loxtep_catalog.
license: MIT
...
- **Empty or sparse results** — Discovery/search may depend on injected services in the AI runtime; dev vs prod can differ.
