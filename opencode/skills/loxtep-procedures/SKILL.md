...
description: Use when the user wants process graph procedures — list procedures, get procedure workflow, create, update, or delete procedures. Customer MCP loxtep_procedures.
license: MIT
