...
description: Use when the user wants entity context, query entity context, decision traces, ontology relationships, thesaurus terms, or resolve canonical keys for process intelligence. Customer MCP loxtep_process_intel. Not the same as loxtep_catalog search or loxtep_schemas.
license: MIT
